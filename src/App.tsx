...
//           <p className="mt-2 text-gray-600">Regístrate o inicia sesión para continuar.</p>
//           <div className="mt-6 flex gap-3">
//             <Link
//               to="/signup"
//               className="inline-flex items-center justify-center rounded-xl bg-[#0B76A0FF] px-5 py-2.5 text-white font-medium hover:opacity-95"
//             >
//               Regístrate
//             </Link>
//             <Link
//               to="/login"
//               className="inline-flex items-center justify-center rounded-xl border border-gray-300 px-5 py-2.5 font-medium hover:bg-gray-50"
//             >
//               Inicia sesión
//             </Link>
//           </div>
